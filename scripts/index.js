// ! Here the store all the list of details (each task will be an object)
// ! state is the current position of the application, future store multiple tasks
const state = {
    taskList: [],
};
...
// ! Creating for task , function body
